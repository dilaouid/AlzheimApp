...
export default function AddQuestion(props) {
    ...
    // add a potential answer to the answers list
    const addAnswer = () => {
    ...
    // take out an answer from the potential answers list
    ...
    // remove the reference file for the question
    const clearFile = () => {
        props.setFileType();
        props.setFilename();
        props.setUri();
    ...
    // import a reference file for the question

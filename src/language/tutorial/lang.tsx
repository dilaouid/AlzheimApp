export const lang: any = {
    fr: {
        ...
        Step1Content: "<strong>AlzApp</strong> est une application qui permet de réaliser un suivi et d'accompagner les personnes atteintes de la maladie d'Alzheimer avec différents jeux et exercices tout aussi ludiques les uns que les autres.",
        ...
        Step3Content: "Vous êtes une structure hospitalière ou une famille, et désirez partager le suivi d'une personne ? C'est possible, le partage est réalisable entre deux appareils par <strong>Bluetooth</strong> !",

        // Fourth step of the tutorial
        Step4Header: "100% gratuit",
        Step4Content: "<strong>Entièrement gratuit, sans publicité</strong>. Il n'y a pas de piège, seulement que l'accompagnement doit se faire gratuitement, la santé doit être accessible pour tous, sans aucun prix.",
        ...
        LastStepHeader: "Prêt à commencer ?",
    },
    en: {
        // First step of the tutorial
        Step1Header: "Welcome to AlzApp",
        Step1Content: "<strong>AlzApp</strong> is an application which would help you create a trace and to accompagny people with Alzheimer's disease with various games and exercices each just as fun as the next.",
        ...
        Step4Content: "<strong>Completly free, without any ad</strong>. There is no trap, just that the accompaniment must be free, because health must be accessible to all, at no cost.",
